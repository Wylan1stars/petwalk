...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-10-2024 a las 21:03:58
...
--
ALTER TABLE `personas`
  ADD CONSTRAINT `personas_ibfk_1` FOREIGN KEY (`id`) REFERENCES `roles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `registrarse_paseador`
--
ALTER TABLE `registrarse_paseador`
  ADD CONSTRAINT `registrarse_paseador_ibfk_1` FOREIGN KEY (`id_registrar_paseador`) REFERENCES `login` (`id_registrar_paseador`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `registrarse_propietario`
--
ALTER TABLE `registrarse_propietario`
  ADD CONSTRAINT `registrarse_propietario_ibfk_1` FOREIGN KEY (`id_registrar_propietario`) REFERENCES `login` (`id_registrar_propietario`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
